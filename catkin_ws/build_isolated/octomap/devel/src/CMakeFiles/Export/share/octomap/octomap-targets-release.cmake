...
set_target_properties(octomath PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboctomath.so.1.9.5"
  IMPORTED_SONAME_RELEASE "liboctomath.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomath )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomath "${_IMPORT_PREFIX}/lib/liboctomath.so.1.9.5" )
...
set_target_properties(octomap PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liboctomap.so.1.9.5"
  IMPORTED_SONAME_RELEASE "liboctomap.so.1.9"
  )

list(APPEND _IMPORT_CHECK_TARGETS octomap )
list(APPEND _IMPORT_CHECK_FILES_FOR_octomap "${_IMPORT_PREFIX}/lib/liboctomap.so.1.9.5" )
