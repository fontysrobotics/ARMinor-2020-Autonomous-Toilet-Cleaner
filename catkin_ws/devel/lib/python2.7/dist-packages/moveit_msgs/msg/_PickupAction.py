    ...
    try:
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v104.subframe_poses:
          ...
          _x = _v118
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v104.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.possible_grasps:
        ...
        _v278 = _v277.header
        buff.write(_get_struct_I().pack(_v278.seq))
        _v279 = _v278.stamp
        _x = _v279
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v278.frame_id
        ...
        _v303 = _v302.header
        buff.write(_get_struct_I().pack(_v303.seq))
        _v304 = _v303.stamp
        _x = _v304
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v303.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v335.subframe_poses:
          ...
          _x = _v349
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v335.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v380.subframe_poses:
          ...
          _x = _v394
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v380.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v396 = _v395.header
        buff.write(_get_struct_I().pack(_v396.seq))
        _v397 = _v396.stamp
        _x = _v397
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v396.frame_id
      ...
      for val1 in self.action_result.result.trajectory_stages:
        ...
        _v400 = _v399.header
        buff.write(_get_struct_I().pack(_v400.seq))
        _v401 = _v400.stamp
        _x = _v401
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v400.frame_id
