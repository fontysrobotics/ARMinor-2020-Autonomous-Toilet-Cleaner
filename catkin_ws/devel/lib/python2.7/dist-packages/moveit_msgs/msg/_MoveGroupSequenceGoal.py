  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.request.items:
        ...
        _v347 = _v346.header
        buff.write(_get_struct_I().pack(_v347.seq))
        _v348 = _v347.stamp
        _x = _v348
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v347.frame_id
        ...
        _v356 = _v355.header
        buff.write(_get_struct_I().pack(_v356.seq))
        _v357 = _v356.stamp
        _x = _v357
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v356.frame_id
        ...
        for val4 in _v351.attached_collision_objects:
          ...
          for val6 in _v364.subframe_poses:
            ...
            _x = _v378
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v364.operation))
          length = len(val4.touch_links)
          buff.write(_struct_I.pack(length))
          for val5 in val4.touch_links:
            length = len(val5)
          ...
          for val6 in _v379.points:
            ...
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
          buff.write(_get_struct_d().pack(val4.weight))
        buff.write(_get_struct_B().pack(_v351.is_diff))
        ...
        for val3 in _v345.goal_constraints:
          ...
          for val4 in val3.orientation_constraints:
            _v391 = val4.header
            buff.write(_get_struct_I().pack(_v391.seq))
            _v392 = _v391.stamp
            _x = _v392
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v391.frame_id
          ...
          for val4 in val3.visibility_constraints:
            ...
            _v401 = _v400.header
            buff.write(_get_struct_I().pack(_v401.seq))
            _v402 = _v401.stamp
            _x = _v402
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v401.frame_id
        ...
        for val4 in _v406.orientation_constraints:
          _v415 = val4.header
          buff.write(_get_struct_I().pack(_v415.seq))
          _v416 = _v415.stamp
          _x = _v416
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v415.frame_id
        ...
        for val4 in _v406.visibility_constraints:
          ...
          _v419 = _v418.header
          buff.write(_get_struct_I().pack(_v419.seq))
          _v420 = _v419.stamp
          _x = _v420
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v419.frame_id
        ...
        for val4 in _v430.constraints:
          ...
          for val5 in val4.orientation_constraints:
            _v439 = val5.header
            buff.write(_get_struct_I().pack(_v439.seq))
            _v440 = _v439.stamp
            _x = _v440
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v439.frame_id
        ...
        for val3 in _v345.reference_trajectories:
          _v454 = val3.header
          buff.write(_get_struct_I().pack(_v454.seq))
          _v455 = _v454.stamp
          _x = _v455
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v454.frame_id
      ...
      for val1 in self.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v478.subframe_poses:
          ...
          _x = _v492
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v478.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v494 = _v493.header
        buff.write(_get_struct_I().pack(_v494.seq))
        _v495 = _v494.stamp
        _x = _v495
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v494.frame_id
