    ...
    try:
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v164.subframe_poses:
          ...
          _x = _v178
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v164.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.request.start_state.attached_collision_objects:
        ...
        _v403 = val1.object
        _v404 = _v403.header
        buff.write(_get_struct_I().pack(_v404.seq))
        _v405 = _v404.stamp
        _x = _v405
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v404.frame_id
        ...
        for val3 in _v403.subframe_poses:
          ...
          _x = _v417
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v403.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_goal.goal.request.goal_constraints:
        ...
        for val2 in val1.position_constraints:
          _v422 = val2.header
          buff.write(_get_struct_I().pack(_v422.seq))
          _v423 = _v422.stamp
          _x = _v423
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v422.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v440 = _v439.header
          buff.write(_get_struct_I().pack(_v440.seq))
          _v441 = _v440.stamp
          _x = _v441
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v440.frame_id
      ...
      for val1 in self.action_goal.goal.request.path_constraints.position_constraints:
        _v445 = val1.header
        buff.write(_get_struct_I().pack(_v445.seq))
        _v446 = _v445.stamp
        _x = _v446
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v445.frame_id
      ...
      for val1 in self.action_goal.goal.request.path_constraints.visibility_constraints:
        ...
        _v457 = _v456.header
        buff.write(_get_struct_I().pack(_v457.seq))
        _v458 = _v457.stamp
        _x = _v458
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v457.frame_id
        ...
        _v463 = _v462.header
        buff.write(_get_struct_I().pack(_v463.seq))
        _v464 = _v463.stamp
        _x = _v464
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v463.frame_id
      ...
      for val1 in self.action_goal.goal.request.trajectory_constraints.constraints:
        ...
        for val2 in val1.position_constraints:
          _v468 = val2.header
          buff.write(_get_struct_I().pack(_v468.seq))
          _v469 = _v468.stamp
          _x = _v469
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v468.frame_id
        ...
        for val2 in val1.orientation_constraints:
          _v476 = val2.header
          buff.write(_get_struct_I().pack(_v476.seq))
          _v477 = _v476.stamp
          _x = _v477
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v476.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v480 = _v479.header
          buff.write(_get_struct_I().pack(_v480.seq))
          _v481 = _v480.stamp
          _x = _v481
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v480.frame_id
          ...
          _v486 = _v485.header
          buff.write(_get_struct_I().pack(_v486.seq))
          _v487 = _v486.stamp
          _x = _v487
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v486.frame_id
      ...
      for val1 in self.action_goal.goal.request.reference_trajectories:
        _v491 = val1.header
        buff.write(_get_struct_I().pack(_v491.seq))
        _v492 = _v491.stamp
        _x = _v492
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v491.frame_id
        ...
        for val2 in val1.cartesian_trajectory:
          _v496 = val2.header
          buff.write(_get_struct_I().pack(_v496.seq))
          _v497 = _v496.stamp
          _x = _v497
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v496.frame_id
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        _v560 = val1.object
        _v561 = _v560.header
        buff.write(_get_struct_I().pack(_v561.seq))
        _v562 = _v561.stamp
        _x = _v562
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v561.frame_id
        ...
        for val3 in _v560.subframe_poses:
          ...
          _x = _v574
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v560.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v576 = _v575.header
        buff.write(_get_struct_I().pack(_v576.seq))
        _v577 = _v576.stamp
        _x = _v577
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v576.frame_id
