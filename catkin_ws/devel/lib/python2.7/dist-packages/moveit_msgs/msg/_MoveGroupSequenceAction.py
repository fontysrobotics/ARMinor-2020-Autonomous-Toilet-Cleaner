    ...
    try:
      ...
      for val1 in self.action_goal.goal.request.items:
        ...
        for val4 in _v7.attached_collision_objects:
          ...
          for val6 in _v20.subframe_poses:
            ...
            _x = _v34
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v20.operation))
        ...
        buff.write(_get_struct_B().pack(_v7.is_diff))
        ...
        for val3 in _v1.goal_constraints:
          ...
          for val4 in val3.visibility_constraints:
            buff.write(_get_struct_d().pack(val4.target_radius))
            ...
            _x = _v55
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
            buff.write(_get_struct_i().pack(val4.cone_sides))
        ...
        for val4 in _v86.constraints:
          ...
          for val5 in val4.position_constraints:
            ...
            for val7 in _v90.primitives:
              buff.write(_get_struct_B().pack(val7.type))
            ...
            for val7 in _v90.mesh_poses:
              ...
              _x = _v94
              buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
            buff.write(_get_struct_d().pack(val5.weight))
          ...
          for val5 in val4.visibility_constraints:
            buff.write(_get_struct_d().pack(val5.target_radius))
            ...
            _x = _v103
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
            buff.write(_get_struct_i().pack(val5.cone_sides))
        ...
        buff.write(_get_struct_d().pack(val1.blend_radius))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v134.subframe_poses:
          ...
          _x = _v148
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v134.operation))
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        _v153 = val1.header
        buff.write(_get_struct_I().pack(_v153.seq))
        _v154 = _v153.stamp
        _x = _v154
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v153.frame_id
      ...
      for val1 in self.action_result.result.response.sequence_start.attached_collision_objects:
        ...
        for val3 in _v179.subframe_poses:
          ...
          _x = _v193
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v179.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        for val3 in _v194.points:
          ...
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        buff.write(_get_struct_d().pack(val1.weight))
      buff.write(_get_struct_B().pack(self.action_result.result.response.sequence_start.is_diff))
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.request.items:
        ...
        _v431 = _v430.header
        buff.write(_get_struct_I().pack(_v431.seq))
        _v432 = _v431.stamp
        _x = _v432
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v431.frame_id
        ...
        for val4 in _v429.attached_collision_objects:
          ...
          _v442 = val4.object
          _v443 = _v442.header
          buff.write(_get_struct_I().pack(_v443.seq))
          _v444 = _v443.stamp
          _x = _v444
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v443.frame_id
          ...
          for val6 in _v442.subframe_poses:
            ...
            _x = _v456
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v442.operation))
          length = len(val4.touch_links)
          buff.write(_struct_I.pack(length))
          for val5 in val4.touch_links:
            length = len(val5)
          ...
          _v458 = _v457.header
          buff.write(_get_struct_I().pack(_v458.seq))
          _v459 = _v458.stamp
          _x = _v459
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v458.frame_id
          ...
          for val6 in _v457.points:
            ...
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
          buff.write(_get_struct_d().pack(val4.weight))
        buff.write(_get_struct_B().pack(_v429.is_diff))
        ...
        for val3 in _v423.goal_constraints:
          ...
          for val4 in val3.position_constraints:
            _v461 = val4.header
            buff.write(_get_struct_I().pack(_v461.seq))
            _v462 = _v461.stamp
            _x = _v462
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v461.frame_id
          ...
          for val4 in val3.visibility_constraints:
            ...
            _v473 = _v472.header
            buff.write(_get_struct_I().pack(_v473.seq))
            _v474 = _v473.stamp
            _x = _v474
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v473.frame_id
            ...
            _v479 = _v478.header
            buff.write(_get_struct_I().pack(_v479.seq))
            _v480 = _v479.stamp
            _x = _v480
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v479.frame_id
        ...
        for val4 in _v484.position_constraints:
          _v485 = val4.header
          buff.write(_get_struct_I().pack(_v485.seq))
          _v486 = _v485.stamp
          _x = _v486
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v485.frame_id
        ...
        for val4 in _v484.orientation_constraints:
          _v493 = val4.header
          buff.write(_get_struct_I().pack(_v493.seq))
          _v494 = _v493.stamp
          _x = _v494
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v493.frame_id
        ...
        for val4 in _v484.visibility_constraints:
          ...
          _v497 = _v496.header
          buff.write(_get_struct_I().pack(_v497.seq))
          _v498 = _v497.stamp
          _x = _v498
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v497.frame_id
          ...
          _v503 = _v502.header
          buff.write(_get_struct_I().pack(_v503.seq))
          _v504 = _v503.stamp
          _x = _v504
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v503.frame_id
        ...
        for val4 in _v508.constraints:
          ...
          for val5 in val4.position_constraints:
            _v509 = val5.header
            buff.write(_get_struct_I().pack(_v509.seq))
            _v510 = _v509.stamp
            _x = _v510
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v509.frame_id
          ...
          for val5 in val4.orientation_constraints:
            _v517 = val5.header
            buff.write(_get_struct_I().pack(_v517.seq))
            _v518 = _v517.stamp
            _x = _v518
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v517.frame_id
          ...
          for val5 in val4.visibility_constraints:
            ...
            _v521 = _v520.header
            buff.write(_get_struct_I().pack(_v521.seq))
            _v522 = _v521.stamp
            _x = _v522
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v521.frame_id
            ...
            _v527 = _v526.header
            buff.write(_get_struct_I().pack(_v527.seq))
            _v528 = _v527.stamp
            _x = _v528
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v527.frame_id
        ...
        for val3 in _v423.reference_trajectories:
          _v532 = val3.header
          buff.write(_get_struct_I().pack(_v532.seq))
          _v533 = _v532.stamp
          _x = _v533
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v532.frame_id
          ...
          for val4 in val3.joint_trajectory:
            _v534 = val4.header
            buff.write(_get_struct_I().pack(_v534.seq))
            _v535 = _v534.stamp
            _x = _v535
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v534.frame_id
          ...
          for val4 in val3.cartesian_trajectory:
            _v537 = val4.header
            buff.write(_get_struct_I().pack(_v537.seq))
            _v538 = _v537.stamp
            _x = _v538
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v537.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        _v556 = val1.object
        _v557 = _v556.header
        buff.write(_get_struct_I().pack(_v557.seq))
        _v558 = _v557.stamp
        _x = _v558
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v557.frame_id
        ...
        for val3 in _v556.subframe_poses:
          ...
          _x = _v570
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v556.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v572 = _v571.header
        buff.write(_get_struct_I().pack(_v572.seq))
        _v573 = _v572.stamp
        _x = _v573
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v572.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.fixed_frame_transforms:
        _v575 = val1.header
        buff.write(_get_struct_I().pack(_v575.seq))
        _v576 = _v575.stamp
        _x = _v576
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v575.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.world.collision_objects:
        _v581 = val1.header
        buff.write(_get_struct_I().pack(_v581.seq))
        _v582 = _v581.stamp
        _x = _v582
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v581.frame_id
      ...
      for val1 in self.action_result.result.response.sequence_start.attached_collision_objects:
        ...
        _v601 = val1.object
        _v602 = _v601.header
        buff.write(_get_struct_I().pack(_v602.seq))
        _v603 = _v602.stamp
        _x = _v603
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v602.frame_id
        ...
        for val3 in _v601.subframe_poses:
          ...
          _x = _v615
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v601.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v617 = _v616.header
        buff.write(_get_struct_I().pack(_v617.seq))
        _v618 = _v617.stamp
        _x = _v618
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v617.frame_id
      ...
      for val1 in self.action_result.result.response.planned_trajectories:
        ...
        _v621 = _v620.header
        buff.write(_get_struct_I().pack(_v621.seq))
        _v622 = _v621.stamp
        _x = _v622
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v621.frame_id
        ...
        _v625 = _v624.header
        buff.write(_get_struct_I().pack(_v625.seq))
        _v626 = _v625.stamp
        _x = _v626
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v625.frame_id
