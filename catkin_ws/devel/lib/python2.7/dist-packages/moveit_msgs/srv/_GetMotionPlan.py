    ...
    try:
      ...
      for val1 in self.motion_plan_request.start_state.attached_collision_objects:
        ...
        for val3 in _v231.subframe_poses:
          ...
          _x = _v245
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v231.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.motion_plan_request.goal_constraints:
        ...
        for val2 in val1.orientation_constraints:
          _v258 = val2.header
          buff.write(_get_struct_I().pack(_v258.seq))
          _v259 = _v258.stamp
          _x = _v259
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v258.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v262 = _v261.header
          buff.write(_get_struct_I().pack(_v262.seq))
          _v263 = _v262.stamp
          _x = _v263
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v262.frame_id
      ...
      for val1 in self.motion_plan_request.path_constraints.visibility_constraints:
        ...
        _v291 = _v290.header
        buff.write(_get_struct_I().pack(_v291.seq))
        _v292 = _v291.stamp
        _x = _v292
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v291.frame_id
      ...
      for val1 in self.motion_plan_request.trajectory_constraints.constraints:
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v308 = _v307.header
          buff.write(_get_struct_I().pack(_v308.seq))
          _v309 = _v308.stamp
          _x = _v309
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v308.frame_id
          ...
          _v314 = _v313.header
          buff.write(_get_struct_I().pack(_v314.seq))
          _v315 = _v314.stamp
          _x = _v315
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v314.frame_id
      ...
      for val1 in self.motion_plan_request.reference_trajectories:
        ...
        for val2 in val1.joint_trajectory:
          _v321 = val2.header
          buff.write(_get_struct_I().pack(_v321.seq))
          _v322 = _v321.stamp
          _x = _v322
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v321.frame_id
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v455.subframe_poses:
          ...
          _x = _v469
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v455.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v471 = _v470.header
        buff.write(_get_struct_I().pack(_v471.seq))
        _v472 = _v471.stamp
        _x = _v472
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v471.frame_id
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.motion_plan_response.trajectory_start.attached_collision_objects:
        ...
        _v521 = val1.object
        _v522 = _v521.header
        buff.write(_get_struct_I().pack(_v522.seq))
        _v523 = _v522.stamp
        _x = _v523
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v522.frame_id
        ...
        for val3 in _v521.subframe_poses:
          ...
          _x = _v535
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v521.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
