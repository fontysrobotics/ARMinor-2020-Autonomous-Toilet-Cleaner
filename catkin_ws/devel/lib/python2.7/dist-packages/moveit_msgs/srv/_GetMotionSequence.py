      ...
      for val1 in self.request.items:
        ...
        for val4 in _v261.attached_collision_objects:
          ...
          for val6 in _v274.subframe_poses:
            ...
            _x = _v288
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v274.operation))
          length = len(val4.touch_links)
          buff.write(_struct_I.pack(length))
          for val5 in val4.touch_links:
            length = len(val5)
          ...
          for val6 in _v289.points:
            ...
            buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
          buff.write(_get_struct_d().pack(val4.weight))
        buff.write(_get_struct_B().pack(_v261.is_diff))
        ...
        for val3 in _v255.goal_constraints:
          ...
          for val4 in val3.position_constraints:
            _v293 = val4.header
            buff.write(_get_struct_I().pack(_v293.seq))
            _v294 = _v293.stamp
            _x = _v294
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v293.frame_id
          ...
          for val4 in val3.visibility_constraints:
            ...
            _v311 = _v310.header
            buff.write(_get_struct_I().pack(_v311.seq))
            _v312 = _v311.stamp
            _x = _v312
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v311.frame_id
        ...
        for val4 in _v316.position_constraints:
          _v317 = val4.header
          buff.write(_get_struct_I().pack(_v317.seq))
          _v318 = _v317.stamp
          _x = _v318
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v317.frame_id
        ...
        for val4 in _v316.visibility_constraints:
          ...
          _v329 = _v328.header
          buff.write(_get_struct_I().pack(_v329.seq))
          _v330 = _v329.stamp
          _x = _v330
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v329.frame_id
          ...
          _v335 = _v334.header
          buff.write(_get_struct_I().pack(_v335.seq))
          _v336 = _v335.stamp
          _x = _v336
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v335.frame_id
        ...
        for val3 in _v255.reference_trajectories:
          ...
          for val4 in val3.joint_trajectory:
            _v366 = val4.header
            buff.write(_get_struct_I().pack(_v366.seq))
            _v367 = _v366.stamp
            _x = _v367
            buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
            _x = _v366.frame_id
    ...
    try:
      ...
      for val1 in self.response.sequence_start.attached_collision_objects:
        ...
        for val3 in _v515.subframe_poses:
          ...
          _x = _v529
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v515.operation))
        ...
        _v531 = _v530.header
        buff.write(_get_struct_I().pack(_v531.seq))
        _v532 = _v531.stamp
        _x = _v532
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v531.frame_id
      ...
      for val1 in self.response.planned_trajectories:
        ...
        _v539 = _v538.header
        buff.write(_get_struct_I().pack(_v539.seq))
        _v540 = _v539.stamp
        _x = _v540
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v539.frame_id
        ...
        for val3 in _v538.points:
          ...
          _x = _v547
          buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
      buff.write(_get_struct_d().pack(self.response.planning_time))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.response.sequence_start.attached_collision_objects:
        ...
        _v593 = val1.object
        _v594 = _v593.header
        buff.write(_get_struct_I().pack(_v594.seq))
        _v595 = _v594.stamp
        _x = _v595
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v594.frame_id
        ...
        for val3 in _v593.subframe_poses:
          ...
          _x = _v607
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v593.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v609 = _v608.header
        buff.write(_get_struct_I().pack(_v609.seq))
        _v610 = _v609.stamp
        _x = _v610
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v609.frame_id
      ...
      for val1 in self.response.planned_trajectories:
        ...
        _v613 = _v612.header
        buff.write(_get_struct_I().pack(_v613.seq))
        _v614 = _v613.stamp
        _x = _v614
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v613.frame_id
