    ...
    try:
      ...
      for val1 in self.goal.request.start_state.attached_collision_objects:
        ...
        for val3 in _v321.subframe_poses:
          ...
          _x = _v335
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v321.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.goal.request.goal_constraints:
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v352 = _v351.header
          buff.write(_get_struct_I().pack(_v352.seq))
          _v353 = _v352.stamp
          _x = _v353
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v352.frame_id
      ...
      for val1 in self.goal.request.path_constraints.visibility_constraints:
        ...
        _v375 = _v374.header
        buff.write(_get_struct_I().pack(_v375.seq))
        _v376 = _v375.stamp
        _x = _v376
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v375.frame_id
        ...
        _v381 = _v380.header
        buff.write(_get_struct_I().pack(_v381.seq))
        _v382 = _v381.stamp
        _x = _v382
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v381.frame_id
      ...
      for val1 in self.goal.request.trajectory_constraints.constraints:
        ...
        for val2 in val1.position_constraints:
          _v386 = val2.header
          buff.write(_get_struct_I().pack(_v386.seq))
          _v387 = _v386.stamp
          _x = _v387
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v386.frame_id
        ...
        for val2 in val1.orientation_constraints:
          _v394 = val2.header
          buff.write(_get_struct_I().pack(_v394.seq))
          _v395 = _v394.stamp
          _x = _v395
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v394.frame_id
        ...
        for val2 in val1.visibility_constraints:
          ...
          _v398 = _v397.header
          buff.write(_get_struct_I().pack(_v398.seq))
          _v399 = _v398.stamp
          _x = _v399
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v398.frame_id
      ...
      for val1 in self.goal.request.reference_trajectories:
        _v409 = val1.header
        buff.write(_get_struct_I().pack(_v409.seq))
        _v410 = _v409.stamp
        _x = _v410
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v409.frame_id
        ...
        for val2 in val1.joint_trajectory:
          _v411 = val2.header
          buff.write(_get_struct_I().pack(_v411.seq))
          _v412 = _v411.stamp
          _x = _v412
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v411.frame_id
        ...
        for val2 in val1.cartesian_trajectory:
          _v414 = val2.header
          buff.write(_get_struct_I().pack(_v414.seq))
          _v415 = _v414.stamp
          _x = _v415
          buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
          _x = _v414.frame_id
      ...
      for val1 in self.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        for val3 in _v433.subframe_poses:
          ...
          _x = _v447
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v433.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
