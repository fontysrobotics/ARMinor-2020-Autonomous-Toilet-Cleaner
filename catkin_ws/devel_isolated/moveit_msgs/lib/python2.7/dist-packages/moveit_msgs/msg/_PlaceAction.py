  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.place_locations:
        ...
        buff.write(_get_struct_d().pack(val1.quality))
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v95.subframe_poses:
          ...
          _x = _v109
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v95.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.place_locations:
        ...
        _v274 = _v273.header
        buff.write(_get_struct_I().pack(_v274.seq))
        _v275 = _v274.stamp
        _x = _v275
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v274.frame_id
      ...
      for val1 in self.action_goal.goal.planning_options.planning_scene_diff.robot_state.attached_collision_objects:
        ...
        _v306 = val1.object
        _v307 = _v306.header
        buff.write(_get_struct_I().pack(_v307.seq))
        _v308 = _v307.stamp
        _x = _v308
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v307.frame_id
        ...
        for val3 in _v306.subframe_poses:
          ...
          _x = _v320
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v306.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
      ...
      for val1 in self.action_result.result.trajectory_start.attached_collision_objects:
        ...
        for val3 in _v351.subframe_poses:
          ...
          _x = _v365
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v351.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
        ...
        _v367 = _v366.header
        buff.write(_get_struct_I().pack(_v367.seq))
        _v368 = _v367.stamp
        _x = _v368
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v367.frame_id
